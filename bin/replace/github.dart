...
git init
git branch -M main
git remote add origin https://github.com/{main_username_owner}/device_application
git remote set-url --push origin https://{main_username_owner}:{main_github_token}@github.com/{main_username_owner}/device_application
