...
Future<void> pubspecUpdate({
  ...
  if (filePubspec.existsSync()) {
    ...
    yaml_code_clone.addAll({
      ...
      "repository": "https://github.com/{main_username_owner}/device_application",
      "homepage": "https://github.com/{main_username_owner}/device_application",
      "issue_tracker": "https://github.com/{main_username_owner}/device_application/issues",
      "documentation": "https://github.com/{main_username_owner}/device_application/tree/main/docs",
      "funding": [
