...
public class DeviceApplicationFlutterChangedListener {

    private final DeviceApplicationFlutterChangedListenerInterface callback;
    private final Set<EventChannel.EventSink> sinks;

    private BroadcastReceiver appsBroadcastReceiver;

    public DeviceApplicationFlutterChangedListener(DeviceApplicationFlutterChangedListenerInterface callback) {
